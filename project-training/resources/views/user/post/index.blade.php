                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <a type="button" class="btn pmd-btn-raised pmd-ripple-effect btn-success" href="{{asset('user/post/create')}}">+
                            </a>
                            <br>
                            <br>
                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        ...
                                        <td class="pmd-table-row-action">
                                            <div >
                                                {{-- Edit button --}}
                                                <a href="{{ asset('user/post/'.$post->id) }}" method="get" class="btn-sm btn pmd-btn-fab pmd-btn-raised pmd-ripple-effect btn-info">
                                                    <i class="material-icons md-dark pmd-xs"><i class="fa fa-edit"></i></i>
                                                </a>

                                                {{-- Delete form --}}
                                                <form action="{{ url('/user/post/delete/'.$post->id) }}" method="get">
